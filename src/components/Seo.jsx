...
export default function Seo({
  ...
  description,
  path = '/',
  image = '/images/gallery/hardwood-refinishing/red-oak-refinish-gloss-hallway.jpg',
  type = 'website',
  schema,
  noindex = false,
}) {
  ...
  const localBusiness = {
    ...
    email: site.email,
    image: `${site.url}/images/gallery/hardwood-refinishing/red-oak-refinish-gloss-hallway.jpg`,
